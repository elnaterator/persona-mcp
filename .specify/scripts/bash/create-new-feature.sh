...
# Function to check existing specs and return next available number
...
if [ -z "$BRANCH_NUMBER" ]; then
    if [ "$HAS_GIT" = true ]; then
        ...
        BRANCH_NUMBER=$(check_existing_specs "$SPECS_DIR")
    else
...
# Spec directory uses numbered prefix for ordering
...
# Set the SPECIFY_FEATURE environment variable to the spec dir name for lookups
